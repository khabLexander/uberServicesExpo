        ...
        <View>
            <View style={stylesCuenta.bannerTop}>
                <View style={stylesCuenta.imgUser}>
                    <Icon style={stylesCuenta.iconUser} name={'person'} size={25} color="#bdb4af" />
                </View>
            ...
            <View>
                ...
                >
                        <Icon style={{marginLeft:20}} name={'shield'} size={25} color="#000000" />
                ...
                >
                        <Icon style={{marginLeft:20}} name={'heart'} size={25} color="#000000" />
                        <Text style={stylesCuenta.textOptions}>
                            Tus favoritos
                        </Text>
                </TouchableOpacity>
                ...
                >
                        <Icon style={{marginLeft:20}} name={'card'} size={25} color="#000000" />
                        <Text style={stylesCuenta.textOptions}>
                            Pago
                        </Text>
                </TouchableOpacity>
                <TouchableOpacity style={stylesCuenta.optionsAccount}>
                        <Icon style={{marginLeft:20}} name={'help-buoy'} size={25} color="#000000" />
                        <Text style={stylesCuenta.textOptions}>
                            Ayuda
                        </Text>
                </TouchableOpacity>
                <TouchableOpacity style={stylesCuenta.optionsAccount}>
                        <Icon style={{marginLeft:20}} name={'briefcase'} size={25} color="#000000" />
                        <Text style={stylesCuenta.textOptions}>
                            Realiza entregas con UberServices
                        </Text>
                </TouchableOpacity>
                <TouchableOpacity style={stylesCuenta.optionsAccount}>
                        <Icon style={{marginLeft:20}} name={'settings'} size={25} color="#000000" />
                        <Text style={stylesCuenta.textOptions}>
                            Configuración
                        </Text>
                </TouchableOpacity>
