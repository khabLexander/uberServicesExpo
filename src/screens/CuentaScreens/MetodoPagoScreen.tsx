...
export const MetodoPagoScreen = () => {
    ...
    return (
        <View>
            ...
            <Text style={stylesCuenta.pagoTitle}>
                Pago
            </Text>
            <Text style={stylesCuenta.metodoPagoLetter}>
                Métodos de pago
            </Text>
                ...
                <View  style={{flexDirection:'column'}}>
                    <TouchableOpacity
                        ...
                        onPress={()=>navigation.navigate('EfectivoScreen')}
                    >
                        <Icon style={stylesCuenta.iconBack} name={'cash-outline'} size={40} color="#000000" />
                        <Text style={{fontSize:20, marginLeft:'10%', marginTop:'2%'}}>Efectivo</Text>
                    </TouchableOpacity>
                    <TouchableOpacity 
                        style={{flexDirection:'row'}}
                    ...
                    >
                        ...
                        <Text style={{fontSize:20, marginLeft:'10%', marginTop:'2%'}}>Tarjeta</Text>
                    </TouchableOpacity>
                </View>
                    <TouchableOpacity>
            ...
            <TouchableOpacity 
                ...
                onPress={()=>navigation.navigate('CuponesScreen')} 
            >
                    <Icon style={stylesCuenta.iconBack} name={'pricetag-sharp'} size={40} color="#000000" />
                    <Text style={{fontSize:20, marginLeft:'10%', marginTop:'2%'}}>Cupones</Text>
                    <Text style={{fontSize:20, position:'absolute', right:'5%', marginTop:'2%'}}>0</Text>
            </TouchableOpacity>

            <TouchableOpacity
                onPress={()=>navigation.navigate('AgregarCuponScreen')} 
            >
